...
COMMONMAKEFILE=../../../$COMMONOUTDIR/j1minivolte-vendor-blobs.mk
...
PRODUCT_COPY_FILES += \\
    \vendor/samsung/j1minivolte/proprietary/sbin/cbd:root/sbin/cbd
...
for FILE in `cat $COMMONPROPS | grep -v ^# | grep -v ^$`; do
    ...
    echo "    \vendor/samsung/j1minivolte/proprietary/$FILE:$FILE$LINEEND" >> $COMMONMAKEFILE
done


(cat << EOF) | sed s/__COMMON__/$COMMON/g | sed s/__VENDOR__/$VENDOR/g > ../../../$COMMONOUTDIR/j1minivolte-vendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
\$(call inherit-product, vendor/__VENDOR__/__COMMON__/j1minivolte-vendor-blobs.mk)
EOF
